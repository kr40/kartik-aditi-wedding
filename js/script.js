...
$(document).ready(function () {
	...
	if (isChromeMobile() || isIOS()) {
		...
		if (audioElm != null) {
			...
			$("#mute-audio")
				.removeAttr("data-mute-icon")
				.attr({ "data-mute-icon": unmute_icon });
			$("#mute-audio")
				.removeAttr("data-unmute-icon")
				.attr({ "data-unmute-icon": mute_icon });
